...
public class LogUtil {
	...
	private final static Logger GATELOG = LoggerFactory.getLogger("POINT_LOG");
	private final static Logger GATELOG_ERROR = LoggerFactory.getLogger("POINT_LOG");
	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("POINT_LOG");
